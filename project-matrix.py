...
while True:
    ...
    print("6. Keluar")
    pilihan_operasi = int(input("Pilih operasi (1-6): "))

    if pilihan_operasi == 1:        # Penjumlahan Matriks 
    ...
    elif pilihan_operasi == 2:      # Pengurangan Matriks
        baris = int(input("Masukkan jumlah baris (max 4): "))
        kolom = int(input("Masukkan jumlah kolom (max 4): "))
        print("Masukkan elemen matriks pertama: ")
        mat1 = []
    ...
    elif pilihan_operasi == 3:      #Perkalian Matriks
    ...
    elif pilihan_operasi == 4:      # Determinan Matriks 
        ...
        def determinan(matrix, n):
            ...
            return det
        print(f"Determinan matriks: {determinan(matrix, n)}")
    
    elif pilihan_operasi == 5:      # Invers Matriks
        n = int(input("Masukkan ukuran matriks persegi (n x n, max 4): "))
        print("Masukkan elemen matriks:")
        matrix = []
        for i in range(n):
        ...
        if det == 0:
            print("Matriks tidak memiliki invers karena determinan = 0.")
        else:
